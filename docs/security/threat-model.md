...
| ---------------------------- | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **S**poofing identity        | Stolen session cookie, credential stuffing              | HttpOnly `__Host-` cookies (✅), hashed session ids (✅), per-IP auth rate limits + account lockout after 10 failures (✅), breached-password check (✅), Turnstile (P1), TOTP 2FA with replay protection and session rotation (✅), required for admins and payees (enforced as those routes ship) |

...
| ---------------------------- | ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **S**poofing identity        | Stolen session cookie, credential stuffing              | HttpOnly `__Host-` cookies (✅), hashed session ids (✅), per-IP auth rate limits + account lockout after 10 failures (✅), breached-password check (✅), Turnstile (P1), 2FA for admins and payees (P1) |

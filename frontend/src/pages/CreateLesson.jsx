                ...
                {videoType === 'url' ? (
                  ...
                  <div className="space-y-2">
                    {videoPreview ? (
                      ...
                      >
                        <Video className="h-12 w-12 mx-auto mb-2 text-muted-foreground text-opacity-60" />
                        <p className="text-sm text-muted-foreground text-opacity-80 mb-1">Click to upload video</p>
                        <p className="text-xs text-muted-foreground text-opacity-60">MP4, AVI, MOV up to 500MB</p>
                        <Input
                          id="video_file"
                          type="file"
                          accept="video/*"
                    ...
                    {uploadProgress > 0 && uploadProgress < 100 && (
                      <div className="space-y-2">
                        ...
                        <div className="w-full bg-card border border-border shadow-sm rounded-full h-2">
                          <div

        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12">
            <div className="max-w-md w-full">
                ...
                <div className={`rounded-xl border p-6 ${result?.valid
                        ...
                        : 'bg-white/[0.04] border-red-500/20'
                    }`}>
                    {/* Status Icon */}
                        ...
                        <div className="space-y-3 border-t border-white/[0.06] pt-5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-white">{result.certificate.user_name}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-white">{result.certificate.course_title}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-medium text-white">{result.certificate.instructor_name}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-mono text-slate-400 break-all">{result.certificate.certificate_id}</p>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    <div className="text-center mt-6 pt-4 border-t border-white/[0.06]">
                        <p className="text-xs text-slate-600">Verified by SkillVerse</p>
                    </div>
                </div>
            </div>
        </div>

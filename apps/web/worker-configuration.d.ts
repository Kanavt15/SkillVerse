/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d3772e1e4b46e1103161358e9e530a70)
// Runtime types generated with workerd@1.20260921.1 2026-08-20
interface __BaseEnv_Env {
	ENVIRONMENT: string;
	TURNSTILE_SITE_KEY: string;
	API: Fetcher /* skillverse-api-staging */ | Fetcher /* skillverse-api */;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		ENVIRONMENT: string;
		TURNSTILE_SITE_KEY: string;
		API: Fetcher /* skillverse-api-staging */;
	}
	interface ProductionEnv {
		ENVIRONMENT: string;
		TURNSTILE_SITE_KEY: string;
		API: Fetcher /* skillverse-api */;
	}
